...
GitHub: @tomcarver16
        ...
        static void Entry(Options options) {
            ...
            if (options.Hostname == null && options.Domain != null) {
                ...
                AD = new ADWrapper(options.Domain, options.Username, options.Password, options.Insecure);
            } else if (options.Hostname != null && options.Domain != null) {
                //This requires the domain so it can be converted into a valid LDAP URI
                AD = new ADWrapper(options.Domain, options.Hostname, options.Port, options.Username, options.Password, options.Insecure);
            } else {
